    ...
    return(
      <View style={styles.background}>
        ...
        <GridImageView data={['https://d1ralsognjng37.cloudfront.net/d3e88525-2584-4a5b-b9e5-ae1ae1f5ad20.jpeg',
          ...
          'https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ftse2.mm.bing.net%2Fth%3Fid%3DOIP.Um2l8w0BdgHZSmYjF4ZqCAHaEq%26pid%3DApi&f=1&ipt=92079f0845a099ff8d29ec01965d54b57ba05adf7cab467dcb377e27a7d18085&ipo=images']} />
      </View>
    );
  }
    ...
    return(
      <View style={styles.background}>
        ...
        <GridImageView data={['http://www.trendmantra.com/wp-content/uploads/2016/03/article205_1.jpg',
          ...
          'https://www.onlyfoods.net/wp-content/uploads/2019/12/Temaki-Sushi.jpg']} />
      </View>
    );
  }
  ...
  return(
    <View style={styles.background}>
      ...
      <GridImageView data={['https://vedicpaths.com/wp-content/uploads/2020/08/istock-955998758.jpg',
        ...
        'https://i.pinimg.com/originals/2d/6d/0b/2d6d0b4c450f52e235ba31853a5d8706.jpg']} />
    </View>
  );
}
